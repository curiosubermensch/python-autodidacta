...
class BiciElectrica(VehiElectricos,Vehiculos): #HERENCIA MULTIPLE: LA PREFERENCIA DE CONSTRUCTOR VA EN ORDEN, EL DEL PRINCIPIO ES EL QUE SE TOMA EN CUENTA
	#la bici electrica tiene todas las caracteristicas de un Vehiculo, por tanto hay que heredar su constructor:
	pass
...
miBici=BiciElectrica("oxford","speedX99") #constructor de VehiElectricos
miBici.estado()
